...
class BookingDetailsBar extends ConsumerWidget {
  ...
  final Map<int, String> bookingStatusMapping;
  ...
  const BookingDetailsBar({
    ...
    required this.bookingStatusMapping,
  });
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: _DesktopInfoItem(
                          ...
                          child: _EllipsisTooltipText(
                            booking.specialRequest?.trim().isNotEmpty == true
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _DesktopInfoItem(
                          ...
                          child: Text(
                            categoryMapping[
                                    roomsCategoryMapping[booking.roomID]] ??
                                'N/A',
                            style: const TextStyle(fontSize: 13),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
