...
import 'package:flutter_academy/app/courses/view_models/category.vm.dart'; // 👉 Needed for typing the edit dialog
                                    ...
                                    onPressed: () async {
                                      final confirm = await showDialog<bool>(
                                            ...
                                            builder: (ctx) => AlertDialog(
                                              ...
                                              content: Text(
                                                  'Are you sure you want to globally delete "${category.name}"?'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.of(ctx)
